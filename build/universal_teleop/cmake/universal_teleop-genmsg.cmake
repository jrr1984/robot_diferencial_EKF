...
set(MSG_I_FLAGS "-Iuniversal_teleop:/home/juan/catkin_ws_2/src/ros-universal-teleop/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/juan/catkin_ws_2/src/ros-universal-teleop/msg/Control.msg" NAME_WE)
add_custom_target(_universal_teleop_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "universal_teleop" "/home/juan/catkin_ws_2/src/ros-universal-teleop/msg/Control.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/juan/catkin_ws_2/src/ros-universal-teleop/msg/Event.msg" NAME_WE)
add_custom_target(_universal_teleop_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "universal_teleop" "/home/juan/catkin_ws_2/src/ros-universal-teleop/msg/Event.msg" "std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/universal_teleop)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/universal_teleop\")")
  # install generated code
  install(
